...
function Document:hintPage(pageno, zoom, rotation, gamma, render_mode)
    --- @fixme: Super-crappy workaround for #7627: if we're eating too much RAM, drop half the cache...
    ---         Revisit once we bump MµPDF...
    Cache:redlineCheck()
